...
# selected_words = random.sample(cleaned_terms, 150)
...
for cluster_id, cluster_word in cluster_representatives.items():
    representative_term_id = cluster_to_term_id[cluster_id]
    if 'representative' not in term_embeddings[representative_term_id]:
